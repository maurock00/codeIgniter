...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>PRUEBAS</b>CODEIGNITER</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Leguearse para iniciar sesión</p>

	<form action="<?php echo base_url();?>cLogin/loguearse" method="POST">	
